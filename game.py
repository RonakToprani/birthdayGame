...
from PyQt5.QtGui import QPixmap, QPainter, QColor, QFont, QPalette, QIcon
from PyQt5.QtWidgets import QApplication, QLabel, QMainWindow, QVBoxLayout, QWidget, QPushButton, QGridLayout, QMessageBox
...
class SpaceTheme(QWidget):
    ...
    def paintEvent(self, event):
        ...
        # Draw background
        painter.setBrush(QPalette().brush(QPalette.Window))
...
class HeartGame(QMainWindow):
    ...
    def paintEvent(self, event):
        ...
        if self.is_alive:
            ...
            pixmap_scaled = self.tishya_pixmap.scaled(40, 40)
...
class MatchingPlaza(QMainWindow):
    ...
    def __init__(self):
        ...
        palette.setColor(QPalette.Window, QColor("#F9E8E2"))  # Warm tone
    ...
    def create_cards(self):
        ...
        for i in range(max_cards):
            ...
            icon_size = card.size() - QSize(20, 20)
    ...
    def card_clicked(self, row, col):
        ...
        if card.isEnabled():
            ...
            icon = QIcon(pixmap.scaled(card.iconSize(), Qt.KeepAspectRatio, Qt.SmoothTransformation))
            card.setIcon(icon)
